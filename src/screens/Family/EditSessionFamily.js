...
const EditSessionFamily = ({navigation, route}) => {
    ...
    const onSubmit = () => {
        ...
        ApiHelper(ServiceUrl.base_url_91 + ServiceUrl.updateFamilySession + '/' + route.params.session.id, data, 'PUT')
            .then(response => {
...
export default EditSessionFamily
