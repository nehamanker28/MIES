...
const UpComingFamily = (props) => {
    ...
    const onPressDelete = (item) => {
        props.navigation.push('CancelSessionFamily', {'session':item})
    }
    ...
    const getSessionsByDate = (date) => {
       ...
       // //console.log('endDay sub------>>>',endDay)
        ...
        getApiHelper(ServiceUrl.base_url_91 + ServiceUrl.familySessions + '?startFromDateTime=' + sTime +'&startToDateTime='+ eTime + '&timeZone='+ timeZone + '&sort=startDateTime,ASC', 'GET')
        .then(response => {
    ...
    const onShowDetail = (item) => {
        ...
        props.navigation.push('SessionDetailFamily', {'session':item})
        //Session Details
    }
