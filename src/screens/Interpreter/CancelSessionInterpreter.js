...
const CancelSessionInterpreter = ({navigation, route}) => {
    ...
    const onSubmit = () => {
        ...
        let data = {
          ...
          ApiHelper(ServiceUrl.base_url_91 + ServiceUrl.cancelInterpreterSession +'/'+ route.params.session.id, data, 'PUT')
          .then(response => {
    ...
    return(
        <ScrollView keyboardShouldPersistTaps='handled' style={styles.containerStyle}>
            ...
            <View style={{  }}>
                ...
                <TouchableOpacity style={{ borderColor: '#0e84d2', borderWidth: 1, height: 50, borderRadius: 10, marginTop: 30, justifyContent: 'center' }} onPress={() => onCancel()}>
...
export default CancelSessionInterpreter