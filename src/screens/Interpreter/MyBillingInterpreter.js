...
const BillingInfoInterpreter = () => {
    ...
    useEffect(() => {
      ...
      const getBillingDetails = () => {
        ...
        getApiHelper(
          ServiceUrl.base_url_91 + ServiceUrl.getInterpreterBillings + '?sort=session.startDateTime,DESC',
          'GET',
        ).then((response) => {
            ...
            <View style={{flex:1, backgroundColor:'white',paddingHorizontal:20}}>
                <View style={{flexDirection:'row', paddingTop:20}}>
                    <View style={{flex:1}}>
                        ...
                        <Text style={{fontFamily:'Roboto-Bold', fontSize:20}}>${(billing.paymentDone + billing.paymentPending).toLocaleString("en-US", { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Text>
                    </View>
                    <View style={{flex:0.7}}>
...
export default BillingInfoInterpreter