...
const SessionDetailInterpreter = ({navigation, route}) => {
    ...
    useEffect(() => {
        ...
        var name = route.params.session.therapist.userProfile.firstName
        if (route.params.session.therapist.userProfile.lastName != null) {
            name = name + ' ' + route.params.session.therapist.userProfile.lastName
        }
    ...
    const onCancel = () => {
        navigation.push('CancelSessionInterpreter', {'session':route.params.session})
    }
                ...
                <ScrollView style={styles.TopViewContainer}>
                    ...
                    <View style={{ flexDirection: 'row'}}>
                        ...
                        <View style={{ flexDirection: 'column', flex:1 }}>
                            ...
                            <Text style={styles.text11}>Therapist</Text>
                            <Text style={styles.text21} numberOfLines={2}>{ therapistName }</Text>
                        </View>
                    </View>
                    <View>
...
export default SessionDetailInterpreter
