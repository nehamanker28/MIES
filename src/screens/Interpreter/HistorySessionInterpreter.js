...
const HistorySessionTherapist = () => {
    ...
    const getSessionsHistory = () => {
        ...
        getApiHelper(ServiceUrl.base_url_91 + ServiceUrl.getSessionForInterpreter + '?endDateTimeLessThan=' + sTime + '&timeZone=' + timeZone + '&sort=startDateTime,DESC' + '&page=' + pageNo + '&size=20', 'GET')
            .then(response => {
