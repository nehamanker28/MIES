...
const HistorySessionTherapist = ({navigation}) => {
    ...
    const getSessionsHistory = () => {
        ...
        getApiHelper(ServiceUrl.base_url_91 + ServiceUrl.getSessionForTherapist + '?endDateTimeLessThan=' + sTime + '&timeZone='+ timeZone + '&sort=startDateTime,DESC'+'&page='+pageNo+'&size=20', 'GET')
        .then(response => {
...
//     return (
//         // <Video source={{uri: data.videoURL + '.m3u8', type:'m3u8', isNetWork: true}}   // Can be a URL or a local file.
//         //     ref={(ref) => {
//         //         //this.player = ref
//         //     }}                                      // Store reference
...
export default HistorySessionTherapist
