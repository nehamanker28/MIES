...
const CancelSessionTherapist = ({navigation, route}) => {
    ...
    const onSubmit = () => {
        ...
        let data = {
          ...
          getApiHelper(ServiceUrl.base_url_91 + ServiceUrl.cancelSessionTherapist +'/'+ route.params.session.id, 'DELETE')
          .then(response => {
...
export default CancelSessionTherapist